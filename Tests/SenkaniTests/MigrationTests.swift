...
struct MigrationRunnerTests {
    ...
    @Test("v22 + v23 + v24 + v25 + v26 + v27 + v28 advance the migration ledger by exactly seven rows over a v21-baseline DB")
    func migration22And23AdvanceLedgerByTwo() throws {
        ...
        // trust_audits (created at v12) so the runner sees exactly seven
        // pending migrations (v22 + v23 + v24 + v25 + v26 + v27 + v28 —
        // v24 ships eval_results self-contained, v25 ships trust_audits
        ...
        // anchor opened lazily by the writers).
        Self.seedPreV22ValidationResults(db)
        ...
        #expect(after - before == 7, "ledger must advance by exactly seven rows (v22 + v23 + v24 + v25 + v26 + v27 + v28); got \(after - before)")
        #expect(report.appliedVersions == [22, 23, 24, 25, 26, 27, 28], "runner must report v22 + v23 + v24 + v25 + v26 + v27 + v28 as the newly-applied versions; got \(report.appliedVersions)")
    }
