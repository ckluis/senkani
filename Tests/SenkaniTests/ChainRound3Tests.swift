...
struct ChainRound3Tests {
    ...
    func verifyAllShape() {
        ...
        // Eleven chain participants: token_events + 3 from T.5 round 3 +
        ...
        // migration v24). Tables with no rows surface as .noChain —
        // still counted in the map shape.
        #expect(perTable.count == 11)
