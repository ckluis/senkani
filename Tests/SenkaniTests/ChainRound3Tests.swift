...
struct ChainRound3Tests {
    ...
    func verifyAllShape() {
        ...
        // Fifteen chain participants: token_events + 3 from T.5 round 3 +
        ...
        // pack_audits (V.11a, migration v20) + eval_results (T.2b-1,
        // migration v24) + surrogate_writes (T.2c-2, migration v27) +
        // workstream_handoffs (U.11a-4, migration v40) +
        // openai_request_log (V.13e-1, migration v41 — wired into verifyAll
        // by chain-verify-openai-request-log-not-in-verifyall-2026-05-27) +
        // thread_handoff_event (V.17c, migration v43).
        // Tables with no rows surface as .noChain — still counted in
        // the map shape.
        #expect(perTable.count == 15)
