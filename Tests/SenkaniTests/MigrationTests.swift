...
struct MigrationRunnerTests {
    ...
    @Test("v22 + v23 + v24 + v25 + v26 + v27 + v28 + v29 advance the migration ledger by exactly eight rows over a v21-baseline DB")
    func migration22And23AdvanceLedgerByTwo() throws {
        ...
        // trust_audits (created at v12) so the runner sees exactly eight
        // pending migrations (v22 + v23 + v24 + v25 + v26 + v27 + v28 +
        // v29 — v24 ships eval_results self-contained, v25 ships
        ...
        #expect(after - before == 8, "ledger must advance by exactly eight rows (v22 + v23 + v24 + v25 + v26 + v27 + v28 + v29); got \(after - before)")
        #expect(report.appliedVersions == [22, 23, 24, 25, 26, 27, 28, 29], "runner must report v22 + v23 + v24 + v25 + v26 + v27 + v28 + v29 as the newly-applied versions; got \(report.appliedVersions)")
    }
