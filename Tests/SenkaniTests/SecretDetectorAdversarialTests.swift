...
@Suite("SecretDetectorAdversarial") struct SecretDetectorAdversarialTests {
    ...
    static let thresholds: [Threshold] = [
        ...
        .init(family: "obfuscated",           minPrecision: 1.00, minRecall: 1.00, note: "66-char pure-hex gap closed 2026-05-01 (cleanup-18c) via long-hex-blob short-circuit (≥40 hex, not a known digest)."),
